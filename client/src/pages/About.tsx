        ...
        <>
            <article>
                <section className="about-block">
                    <FadeInSection>
                        <blockquote className="header-p"><i><b>"Our mission is to provide inclusive, accessible, and high-quality movement-based programs that promote physical literacy, health, and lifelong well-being for individuals of all ages and abilities."</b></i></blockquote>
                        <blockquote className="header-p"><i><b>"Through youth sports, skill development clinics, and active aging programs, we aim to build strong foundations in motor skills, confidence, and social connection. We are committed to removing barriers to participation by offering free and low-cost opportunities that serve diverse populations, including beginners, individuals with limited mobility, and underserved community members."</b></i></blockquote>
                    </FadeInSection>
                </section>
                <section className="about-block two-col">
                    <FadeInSection delay={150}>
                        <img src="/exsa-group.jpeg" alt="Exsa Youth Gymnastics" />
                    </FadeInSection>
                ...
                <section className="about-block two-col reverse">
